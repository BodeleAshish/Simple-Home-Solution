            ...
            <div class="container-fluid">
                ...
                <form action="<?php echo substr($_SERVER['REQUEST_URI'],32);?>" class="form-inline my-2 my-lg-0 mx-auto" method="post">
                    ...
                    if (isset($_SESSION['username'])) : ?>
                        ...
                        <p class="mx-3"> <a href="<?php echo substr($_SERVER['REQUEST_URI'],32); ?>?logout=\'1\'" style="color: red;">logout</a> </p>
                    <?php endif ?>
                    <?php } else {
                    // display login link
                    ?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="login-form mx-5">
                                        <form action="<?php echo substr($_SERVER['REQUEST_URI'],32);?>" method="post">      
